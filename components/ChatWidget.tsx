...
export default function ChatWidget() {
  ...
  const handleClearChat = () => {
    ...
    setEngine('Local Heuristic Engine');
  };
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 font-mono">
      ...
      {isOpen && (
        <div
          className={`flex flex-col bg-[#0b1329]/95 backdrop-blur-md rounded-2xl border border-slate-700/60 shadow-2xl overflow-hidden scale-in-chat transition-all duration-300 ease-in-out ${
            isMaximized ? 'fixed inset-4 sm:inset-6 md:inset-12 z-[60]' : 'h-[550px] w-[400px]'
          }`}
