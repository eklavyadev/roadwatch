...
export default function ReportPotholePage() {
  ...
  return (
    <div className="min-h-screen bg-transparent text-white px-2 py-4">
      <style>{`.fixed.bottom-6.right-6 { display: none !important; }`}</style>
      <div className="mx-auto max-w-xl bg-[#0f172a] p-6 rounded border border-slate-700 shadow-xl">
